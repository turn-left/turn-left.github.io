...
> jdk 编辑生成的.class文件是16进制数据文件，可通过**[javap](https://docs.oracle.com/javase/8/docs/technotes/tools/windows/javap.html)**命令进行反汇编，得到字节码文件。
>
> 把`JVM`虚拟机字节指令表整理了一下，方便查阅与复习。
...
转自：https://segmentfault.com/a/1190000008722128
